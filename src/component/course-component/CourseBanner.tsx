                ...
                <div className="w-full lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
                    ...
                    <div className="flex items-center mb-6 relative overflow-hidden h-16">
                        ...
                        <span
                            ...
                            className="text-xl sm:text-2xl lg:text-3xl font-bold ml-4 text-black"
                        >
                            ₹999
                        </span>
                        <span

                            className="text-2xl sm:text-3xl lg:text-4xl  font-bold line-through text-orange-500 absolute left-14 m-32 sm:left-24"
                        >
                            ₹3999
                        </span>
                    </div>
