...
import icon6 from '../../assets/icons/Business Owner.svg'
            ...
            <div className="lg:w-3/4">
                <div className="flex flex-col  sm:flex-row gap-4">
                    ...
                    <div className="bg-blue-100 p-4 space-y-12 rounded-lg border border-blue-900 text-center flex-1">
                        <span className="text-3xl sm:text-4xl mb-2 block">
                            <img src={icon5} alt="Market Research" className="w-14 p-2 bg-orange-200 rounded-full h-14" />
                        </span>
                        <p className="font-bold text-sm sm:text-base">Aspiring entrepreneurs</p>
                    </div>
                    <div className="bg-blue-100 p-4 space-y-12 rounded-lg border border-blue-900 text-center flex-1">
                        <span className="text-3xl sm:text-4xl mb-2 block">
                            <img src={icon6} alt="Market Research" className="w-14 p-2 bg-orange-200 rounded-full  h-14" />
                        </span>
